...
<br />
<div align="center">
  <a href="https://github.com/MinerProxyBTC/GoMinerTool">
...
bash <(curl -s -L https://raw.githubusercontent.com/MinerProxyBTC/GoMinerTool/main/linux-install.sh) -update
...
````
bash <(curl -s -L https://raw.githubusercontent.com/MinerProxyBTC/GoMinerTool/main/linux-install.sh) -uninstall
...
1. 前往 [https://github.com/MinerProxyBTC/GoMinerTool/tree/main/Windows-64](https://github.com/MinerProxyBTC/GoMinerTool/tree/main/Windows-64) 下载windows下的执行程序
<table>
    <tr>
        <td>
            <center>
